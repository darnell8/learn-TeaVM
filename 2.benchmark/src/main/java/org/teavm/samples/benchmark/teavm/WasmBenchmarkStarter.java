...
public final class WasmBenchmarkStarter {
    ...
    @Import(module = "org/teavm/samples/benchmark", name = "setupCanvas")
    private static native void setupCanvas();

    @Import(module = "org/teavm/samples/benchmark", name = "performanceTime")
    private static native double performanceTime();

    @Import(module = "org/teavm/samples/benchmark", name = "reportPerformance")
    private static native void reportPerformance(int second, int timeSpentCalculating);

    @Import(module = "org/teavm/samples/benchmark", name = "repeatAfter")
